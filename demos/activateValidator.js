...
async function params() {
    ...
    // todo: need fill info 
    // note: you need register validator first
    const description = "propose: activeate validator";
    const upgradeSelector = "activateValidator";
    const validatorAddress = "0x0000000000000000000000000000000000000000"; // todo: put in the validator address


    const transferCalldata = await contract.stakingContract.interface.encodeFunctionData(upgradeSelector, [validatorAddress]);
